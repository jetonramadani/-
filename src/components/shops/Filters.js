    ...
    return (
        <>
            ...
            <form noValidate autoComplete="off" className={classes.searchBar}>
                <TextField id="outlined-basic" label="Search shops by name, city or category" variant="outlined" className={classes.textField} />
            </form>
            <div className={classes.checkBoxes}>
                <MultipleCheckboxes />
                <MultipleCheckboxes />
                <Button variant="contained" color="primary" style={{ width: "25%", marginRight: "6%" }} size="large" >
                    Apply
                </Button>
            </div>
        </>
